...
const styles = {
    ...
    button: 'w-[150px] bg-[#F2A533] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    cart_button: "px-[20px] h-[38px] rounded-[20px] border border-[#123243] bg-[#F2A533] flex items-center justify-center cursor-pointer",
