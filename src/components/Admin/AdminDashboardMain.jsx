        ...
        adminOrderLoading ? (
          ...
          <div className="w-full p-4">
            ...
            <div className="w-full block 800:flex items-center justify-between">
              <div className="w-full mb-4 800:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
              ...
              <div className="w-full mb-4 800:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
                ...
                <h5 className="pt-2 pl-[36px] text-[22px] font-[500]">{adminsellers && adminsellers.length}</h5>
