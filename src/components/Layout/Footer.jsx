...
const Footer = () => {
  return (
    <div className="bg-[#000] text-white">
      <div className="md:flex  md:justify-between  md:items-center sm:px-12 px-4 bg-[#F2A533] py-7">
        ...
        <div>
          <input
            ...
            className="text-gray-800 placeholder-white bg-transparent border border-white
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center">
        ...
        <ul className="text-center sm:text-start">
          ...
          <div className="grid grid-cols-1 sm:grid-2 lg:grid-cols-3 gap-10 text-center pt-2 text-gray-400 text-sm pb-8">
            <span>© 2020 E-shop.com All rights reserved.</span>
